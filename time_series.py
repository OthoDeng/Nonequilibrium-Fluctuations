...
YR = np.arange(1949, 2026) # Assuming time dimension matches this range
...
# fig.suptitle(f'Time Series Statistics for {var.upper()} by Latitude Band (Weighted)', fontsize=16)
...
axes[2].set_ylabel(f'$\\gamma_A$', fontsize=12) # Add symbol if desired, e.g., ($\\gamma_A$)
axes[2].legend()
axes[2].grid(True)
